    ...
    public class UsuarioController : Controller
    {
               ...
               try
              {
                ...
                if (foto != null) {
                    ...
                    fotoStream = foto.OpenReadStream();
                     ...
                     Usuario usuario_creado = (await _usuarioServicio.Crear(_mapper.Map<Usuario>(vmUsuario), fotoStream, nombreFoto, urlPlantillaCorreo)).FirstOrDefault();
        ...
        public async Task<IActionResult> Editar([FromForm] IFormFile foto, [FromForm] string modelo)
        {
            ...
            try
            {
                ...
                Usuario usuario_editado = (await _usuarioServicio.Editar(_mapper.Map<Usuario>(vmUsuario), fotoStream, nombreFoto)).FirstOrDefault();
