...
$(document).ready(function () {
    ...
    fetch("/Entrada/ListaTipoDocumentoVenta")
        .then(response => {
...
//    $("#txtFechaCaducidad").datepicker({ dateFormat: "dd/mm/yy" })
        ...
        .then(responseJson => {
            ...
            if (responseJson.estado) {
               ...
               /* $("#txtFechaCaducidad").val("")*/
                ...
                swal("Registrado", `Numero Entrada: ${responseJson.objeto.numeroEntrada}`, "success")
            } else {
                swal("Lo sentimos", "No se pudo registrar la Entrada1", "error")
