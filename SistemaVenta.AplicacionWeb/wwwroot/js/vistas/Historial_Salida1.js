...
$("#btnBuscar").click(function () {
    ...
    fetch(`/Salida/Historial?numeroVenta=${numeroVenta}&fechaInicio=${fechaInicio}&fechaFin=${fechaFin}`)
        .then(response => {
...
$("#tbventa tbody").on("click", ".btn-info", function () {
    ...
    $("#linkImprimir").attr("href", `/Salida/MostrarPDFVenta?numeroVenta=${d.numeroVenta}`)
