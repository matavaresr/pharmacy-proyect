...
$(document).ready(function () {
    ...
    fetch("/Salida/ListaTipoDocumentoVenta")
        .then(response => {
    ...
    fetch("/Salida/RegistrarVenta", {
        ...
        .then(responseJson => {
            ...
            if (responseJson.estado) {
                ...
                swal("Registrado", `Numero Salida: ${responseJson.objeto.numeroVenta}`, "success")
            } else {
