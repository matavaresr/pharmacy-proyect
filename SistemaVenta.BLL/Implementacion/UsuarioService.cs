...
namespace SistemaVenta.BLL.Implementacion
{
    public class UsuarioService : IUsuarioService
    {
        ...
        public async Task<List<Usuario>> Crear(Usuario entidad, Stream Foto = null, string NombreFoto = "", string UrlPlantillaCorreo = "")
        {
            ...
            try
            {
                ...
                return new List<Usuario> {usuario_creado};
            }
            catch (Exception ex)
            {
                throw;
        ...
        public async Task<List<Usuario>> Editar(Usuario entidad, Stream Foto = null, string NombreFoto = "")
        {
            ...
            try
            {
                ...
                return new List<Usuario> {usuario_editado}; 
            }
        ...
        public async Task<bool> RestablecerClave(string Correo, string UrlPlantillaCorreo)
        {
            try
            {
                ...
                if(correo_enviado == false)
                    throw new TaskCanceledException("Tenemos problemas. Porfavor intentalo denuevo o mas tarde");
