...
namespace SistemaVenta.BLL.Implementacion
{
    public class DashBoardService : IDashBoardService
    {
        ...
        private readonly IGenericRepository<DetalleEntrada> _repositorioDetalleEntrada;
        ...
        public DashBoardService(
            ...
            IGenericRepository<DetalleEntrada> repositorioDetalleEntrada,
            ...
            )
        {
            ...
            _repositorioDetalleEntrada = repositorioDetalleEntrada;
        ...
        public async Task<Dictionary<string, int>> ProductosTopUltimaSemana()
        {
            try
            {
                ...
                Dictionary<string,int>resultado = query
                    ...
                    .GroupBy(dv => dv.MarcaProducto).OrderByDescending(g => g.Count())
        ...
        public async Task<int> TotalEntradas()
        {
